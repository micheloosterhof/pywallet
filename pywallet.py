...
balance_site ='https://api.blockcypher.com/v1/btc/main/addrs/'

aversions = {}
for i in range(256):
    aversions[i] = "version %d" % i
aversions[0] = "Bitcoin"
aversions[25] = "BitCanna"
...
KeyInfo = collections.namedtuple(
    "KeyInfo", "secret private_key public_key addr wif compressed"
)
...
def read_wallet(
    ...
    def item_callback(type, d):
        ...
        elif type == b"bestblock" and 'hashes' in d and len(d['hashes'])>0:
...
def update_pyw():
    if md5_last_pywallet[0] and md5_last_pywallet[1] not in md5_pywallet:
        ...
        if len(dl) > 40 and md5_2(dl) == md5_last_pywallet[1]:
            ...
            return (
                "Problem when downloading new version ("
                + md5_2(dl)
                + "/"
                + md5_last_pywallet[1]
                + ")"
...
class TestPywallet(unittest.TestCase):
    ...
    def test_btc_bip32_test_vectors(self):
        self.assertEqual(
            ...
            .ckd_xpriv(0x80000000, 1, -2, 2, 1000000000)
            .xpub(),
        ...
        self.assertEqual(
            ...
            .ckd_xpriv(0, -2147483647, 1, -2147483646, 2)
            .xpub(),
